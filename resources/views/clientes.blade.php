...
<body class="w-screen h-screen overflow-x-hidden bg-[#F9EFDB]">
    <a href="{{Route('clientesaddView')}}" class="m-5 p-1 rounded-md bg-green-600 w-[200px] justify-center flex mt-5 border-2 font-semibold text-white hover:bg-green-500">Adicionar cliente</a>
            ...
            foreach ($info as $key => $value) {
                ...
                <div class="pl-10 bg-[#ECDDBF] p-6 pt-2 rounded-md w-[400px]">
                    <div class="flex flex-row items-center justify-start gap-4 font-bold">
                        <img src="{{asset('img/clienteProf.png')}}">
                    ...
                    <div class="grid grid-cols-2 mt-2">
                        ...
                        <div class="col-span-1 flex flex-row justify-center items-center gap-2">
                            <img src="{{asset('img/whats.png')}}" class="w-4 h-4">
                            <div>
                    ...
                    <div class="flex flex-row justify-center items-center gap-2 mt-2">
                        <img src="{{asset('img/pin.png')}}" class="w-4 h-4 col-span-1">
                    ...
                    <div class="flex gap-3 flex-row items-center justify-end">
                        <form action="{{Route('clientesDel')}}" method="post">
                            @csrf
                            @method('delete')
                            <input type="hidden" name="id" value="{{$value['id']}}">
                            <button type="submit" class="flex justify-center items-center 
                            rounded-md px-2 py-1 bg-red-500 hover:bg-red-400">Deletar</button>
                        </form>
                        <a href="{{Route('clientesaddView')}}?id=<?php echo $value['id']; ?>"
